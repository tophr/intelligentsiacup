...
*/
(function(p){p.fn.countdown=function(y){var a={},t=/(%\{d\}|%\{h\}|%\{m\}|%\{s\})/g,u=/%\{d\}/,v=/%\{h\}/,w=/%\{m\}/,x=/%\{s\}/,n=false,j,f=Math.floor;p.extend(a,{date:new Date,updateTime:1E3,htmlTemplate:'%{d} <span class="cd-time">days</span> %{h} <span class="cd-time">hours</span> %{m} <span class="cd-time">minutes</span> %{s} <span class="cd-time">seconds</span>',minus:false,onChange:null,onComplete:null,leadingZero:false},y);j=a.htmlTemplate;return this.each(function(){var g=p(this),o,k=new Date,l=
